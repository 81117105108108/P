...
- **预期**：每个工具栏芯片仅显示其字形，并带有标签
  在悬停和键盘焦点时显示为完全可见的工具提示，浮动在按钮上方 (#74)；
  无芯片渲染标题文本。工具提示的浮动表面与图标
  的悬停高亮保持距离，因此其下边框永远不会与按钮
  的高亮融为一体。辅助工具栏提供复制、分叉、重新生成；
...
- **链接规格**：`04-ux/07-ui-design-system.md` §8、`04-ux/02-i18n-english-first.md`、决策日志 D146 / D304 / D347
- **验收**：A（应用程序启动），质量
- **里程碑**：M5
#### E2E-099：品牌标志遵循活跃主题
- **状态**：草案
