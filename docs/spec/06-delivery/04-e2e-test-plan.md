...
#### E2E-213: Vercel documentation deployment runs only for releases

- **Preconditions**: The Vercel project uses `docs` as its Root Directory;
  `VERCEL_TOKEN`, `VERCEL_ORG_ID`, and `VERCEL_PROJECT_ID` are configured as
  GitHub Actions secrets.
- **Steps**: 1) Update a pull request and push an ordinary branch commit;
  inspect the Vercel result. 2) Run the Release workflow for a matching
  `vX.Y.Z` tag. 3) Inspect the `deploy-docs` job and the production
  documentation site.
- **Expected**: Pull request and ordinary branch Git deployments are disabled
  by `git.deploymentEnabled: false` and do not build a Preview or create a
  Vercel status check. After the GitHub Release is published, `deploy-docs`
  invokes Vercel CLI with `--prod`, and the production documentation site
  reflects the tag.
- **Specs linked**: `02-architecture/04-documentation-site.md`,
  `06-delivery/06-release-runbook.md`, ADR 0199
- **Acceptance**: Quality (release delivery)
- **Milestone**: M6+
- **Status**: Source-contract covered (`ci-workflow.test.mjs`); remote Vercel
  deployment and GitHub status behavior remain operator validation (do not run
...
| M6+ | E2E-121, E2E-122, E2E-148, E2E-150, E2E-151, E2E-154, E2E-155, E2E-158, E2E-159, E2E-160, E2E-161, E2E-162, E2E-163, E2E-166, E2E-168, E2E-173, E2E-174, E2E-176, E2E-179, E2E-196a, E2E-196b, E2E-196c, E2E-198, E2E-199, E2E-200, E2E-202, E2E-203, E2E-205, E2E-209, E2E-210, E2E-212, E2E-213 |
...
#### E2E-204: Plugin session import and ownership boundary
...
#### E2E-205: Plugin batch and delete lifecycle
...
- **Specs linked**: `03-runtime/04-data-storage.md`,
  `03-runtime/06-host-rpc-protocol.md`, ADR 0195, D357
